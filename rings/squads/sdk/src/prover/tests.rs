//! End-to-end key-encryption proof test. Build the proof inputs in Rust, get a real
...
use crate::prover::key_encryption::{KeyEncryptionProofInputs, KeyEncryptionProofResult};
...
/// Used for the nullifier secret, a BN254 field element by design. The viewing and
/// ephemeral secrets are full-range P-256 scalars.
...
/// Host mirror of the program's `verify_groth16` (program/src/shared/proof.rs)
/// for the 192-byte BSB22 proof.
