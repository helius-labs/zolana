//! Key-update proposal family. `update_viewing_key_account` (tag 6) creates
//! the proposal that `fill_key_update`, `execute_key_update`, and
//! `cancel_key_update` then operate on.
