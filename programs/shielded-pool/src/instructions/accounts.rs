...
use zolana_interface::{
    instruction::instruction_data::proofless_shield::CpiSignerData, SHIELDED_POOL_CPI_AUTHORITY,
    SHIELDED_POOL_CPI_AUTHORITY_BUMP,
};
...
pub(crate) fn load_transact_accounts<'a>(
    ...
    validate_cpi_signer(&account_snapshot, data.cpi_signer, cpi_signer_seed)?;
