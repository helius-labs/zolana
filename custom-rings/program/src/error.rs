...
pub enum CustomRingError {
    ...
    #[error("ring_auth account is missing from the forwarded account list")]
    ...
    #[error("auditor public key is not a SEC1-compressed point")]
    ...
    #[error("circuit selector is not supported by this ring")]
    ...
    #[error("reader key is not a P-256 or ed25519 public key")]
