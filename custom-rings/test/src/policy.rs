//! Entry writes and governed transfers shared by the suites behind the rule features.

use anyhow::{anyhow, Result};
use custom_ring_interface::RULES;
use custom_ring_sdk::{
    CreateEntry, CustomRing, CustomRingTransfer, CustomRingTransferInput, DepositAsset,
    EntryProofEnvironment, ProvenTransfer, ReadEntry, RingDeposit, RingDepositReceipt,
    TransferError, TransferProofEnvironment, UpdateEntry, V0WithLookupTable,
