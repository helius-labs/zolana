...
/// Binds the audited transaction to the ring's policy and execution-time amount controls.
...
/// Extends the policy statement with the atomic current-record head transition.
