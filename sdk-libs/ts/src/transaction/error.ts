...
export const TRANSACTION_ERROR_CODES = Object.freeze([
  ...
  "TRANSACTION_DUPLICATE_SLOT_INDEX",
  "TRANSACTION_ED25519_PAYER_MISMATCH",
  "TRANSACTION_EXCESS_OUTPUT_SLOTS",
  "TRANSACTION_FIRST_NULLIFIER_MISMATCH",
  "TRANSACTION_INPUT_OUTSIDE_RING",
  ...
  "TRANSACTION_INVALID_TREE_ID",
  "TRANSACTION_KEYPAIR",
  "TRANSACTION_KEYS_BATCH_MISMATCH",
  "TRANSACTION_KEYS_IDENTITY_MISMATCH",
  "TRANSACTION_KEYS_UNRESOLVED",
  ...
  "TRANSACTION_NO_DUMMY_OWNER_TAG_PARTICIPANT",
  ...
  "TRANSACTION_OWNER_TAG_MISMATCH",
  ...
  "TRANSACTION_TOO_MANY_INPUT_TREES",
