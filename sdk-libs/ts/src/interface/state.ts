...
// Pinned by `program-libs/tree/tests/layout.rs`.
export const UTXO_ROOT_HISTORY_CURSOR_OFFSET = 112;
export const UTXO_ROOT_HISTORY_LEN_OFFSET = 114;
export const UTXO_ROOT_HISTORY_CAPACITY_OFFSET = 116;
export const UTXO_SUBTREES_LEN_OFFSET = 118;
export const UTXO_ROOT_HISTORY_OFFSET = 1_152;
export const UTXO_ROOT_HISTORY_CAPACITY = STATE_ROOT_HISTORY_CAPACITY;
export const NULLIFIER_ROOT_HISTORY_CURSOR_OFFSET = 17_224;
export const NULLIFIER_ROOT_HISTORY_OFFSET = 17_232;
