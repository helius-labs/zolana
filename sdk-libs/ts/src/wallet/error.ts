...
export const WALLET_ERROR_CODES = [
  ...
  "WALLET_BUILD_PRIVATE_TRANSACTION",
  "WALLET_BUILD_REGISTRATION",
  "WALLET_CREATE_ASSOCIATED_TOKEN_ACCOUNT",
  "WALLET_CREATE_DEPOSIT",
  "WALLET_CREATE_TRANSFER",
  "WALLET_DEPOSIT",
  "WALLET_DUPLICATE_INPUT_UTXO",
  "WALLET_ENSURE_REGISTERED",
  "WALLET_FETCH_USER_RECORD",
  "WALLET_INCOMPLETE_SIGNATURES",
  ...
  "WALLET_SIGN_PRIVATE_TRANSACTION",
  "WALLET_SPLIT_INPUT_HAS_DATA",
  "WALLET_SPLIT_INPUT_ZONE_MISMATCH",
  "WALLET_SPLIT_INVALID_PART_COUNT",
  "WALLET_SPLIT_NOT_DIVISIBLE",
  "WALLET_SUBMIT_MERGE",
  "WALLET_SUBMIT_PRIVATE_TRANSACTION",
  "WALLET_SYNC",
  "WALLET_TOO_MANY_ACCOUNTS",
  "WALLET_TOO_MANY_INPUTS",
  "WALLET_TRANSACTION_ASSEMBLY",
  "WALLET_UNSIGNED_INPUT_UNAVAILABLE",
  "WALLET_UNSUPPORTED_TRANSACTION_SIGNER",
