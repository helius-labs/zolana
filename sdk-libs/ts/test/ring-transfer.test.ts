...
it("frames sponsored full-withdrawal dummy outputs using the shared Rust vector without changing the spend", async () => {
  ...
  expect(framed.blindingSeed).toEqual(input.blindingSeed);
  expect(framed.outputTreeId).toBe(input.outputTreeId);
