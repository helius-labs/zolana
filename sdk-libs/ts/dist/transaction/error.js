...
export const TRANSACTION_ERROR_CODES = Object.freeze([
    ...
    "TRANSACTION_SPLIT_INPUT_ZONE_MISMATCH",
...
export function transactionError(code, details, cause) {
...
function isCauseCategory(value) {
...
function safeDetails(details) {
    if (details === undefined)
        return undefined;
    const safe = Object.fromEntries(Object.entries(details).flatMap(([key, value]) => {
        if (/(secret|private|seed|blinding|nonce|scalar|signature)/iu.test(key))
            return [];
