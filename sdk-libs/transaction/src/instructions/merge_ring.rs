...
//! owned by; [`PreparedMergeRing`] pads to the smallest supported shape that
//! fits and yields the input commitments to fetch Merkle proofs for. Like the
//! default merge, the merge-ring
...
impl MergeRing {
    ...
    pub fn new<K: ShieldedKeypairTrait>(
        ...
        let mut output = match output_ring_data_hash {
