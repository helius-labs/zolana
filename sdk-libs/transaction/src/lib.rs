...
pub use wallet::{
    ...
    AnonymousRecipientSlot, ApprovalRequest, AssetBalance, EncryptedSplit, EncryptedTransfer,
    Filter, LocalWalletAuthority, P256Signature, PrivateTransaction, PrivateTransactionDirection,
