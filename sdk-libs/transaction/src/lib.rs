...
pub use wallet::{
    ...
    AnonymousRecipientSlot, ApprovalRequest, AssetBalance, Balances, ChainPosition,
    ClientEd25519WalletAuthority, CursorStream, EncryptedEnvelope, EncryptedSplit,
    EncryptedTransfer, Filter, KeypairWalletAuthority, P256Signature, PrivateTransaction,
    PrivateTransactionDirection, PrivateTransactionId, PrivateTransactionKind,
    PrivateTransactionStatus, RingBalance, SyncReport, SyncWalletAuthority, ViewingKeyEntry,
    Wallet, WalletAuthority, WalletSyncMaterial, WalletUtxo, DEFAULT_TAG_WINDOW,
};
