...
pub(crate) fn input_utxo(owner: PublicKey, asset: Address, amount: u64, seed: u8) -> Utxo {
    Utxo {
        owner,
        asset,
        amount,
...
pub(crate) fn standard_transfer_round_trips(
...
pub(crate) fn split_round_trips(world: &mut TransactionWorld, name: String) {
    let registry = registry();
