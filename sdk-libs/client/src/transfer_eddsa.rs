...
pub struct TransferEddsaProver {
...
#[derive(Debug, Clone)]
pub struct TransferEddsaProofResult {
    pub inputs: TransferEddsaInputs,
...
impl TransferEddsaProver {
    pub fn build(self) -> Result<TransferEddsaProofResult, ClientError> {
        ...
        let inputs = TransferEddsaInputs {
