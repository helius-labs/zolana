...
to produce `MoproWasmBindings`. The CLI automatically pins generated gnark apps'
`mopro-ffi` dependency to Git commit `decffd93936a55948687568e2f51ccb786d93910`
while this code is unreleased; no local Mopro checkout is required. The setup
instructions also show the override for apps generated by an older CLI.
