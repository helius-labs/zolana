...
- Primary rows: `118`
- Progress: `31 done / 118 total`; `76 needs_fix`; `0 needs_re_review`; `11 todo`
- Exact next eligible row: `C12 sdk-libs/client/src/prover/transact/p256_and_eddsa.rs`
- Active reviews: `C05-C20 client prover worker`; `C21, C22` deferred until the client retry and error fix commits
