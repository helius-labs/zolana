...
- Branch: `ts-sdk-port`
- Review HEAD: `58b2be6a` at `2026-07-25 18:52 UTC`
...
- Progress: `5 done / 118 total`; `70 needs_fix`; `42 needs_re_review`; `1 todo`, counted at `2026-07-25 19:05 UTC` against the Status column. Fix workers land commits while this block is read, so recount before you cite a number. `npm run check:planning` fails when this count disagrees with the tables
