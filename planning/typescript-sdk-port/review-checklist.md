...
- Primary rows: `118`
- Progress: `31 done / 118 total`; `59 needs_fix`; `1 needs_re_review`; `0 in_progress`
- Exact next eligible row: `C04 sdk-libs/client/src/indexer.rs` re-review
- Active reviews: `C04 re-review`
...
| C04 | `sdk-libs/client/src/indexer.rs` | `client/src/indexer.ts` | needs_re_review | PARITY | committed | The asynchronous adapter preserves the four requests, owned conversions, block-time polling, bounded failures, browser operation, and Rust-only blocking disposition. | 2026-07-24 re-review | `7cb3acda` |
