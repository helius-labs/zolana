...
- Branch: `ts-sdk-port`
- Review HEAD: `1d6b9873bcf096c33511c3f46af361b272bc34a2`
...
- Progress: `31 done / 118 total`; `69 needs_fix`; `18 needs_re_review`; `0 todo`, counted at `2026-07-25 14:45 UTC`. Fix workers land commits while this block is read, so recount the Status column of the queue tables before you cite a number
...
- Active reviews: `C01-C22` reviewed `2026-07-25`; the client package gates stay unchecked while 11 client rows wait on re-review. `C21` closed the last `todo` row and is `DIVERGENT` on legacy-message account order
