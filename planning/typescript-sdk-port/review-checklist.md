...
- Primary rows: `118`
- Progress: `31 done / 118 total`; `60 needs_fix`; `0 needs_re_review`; `27 todo`
- Exact next eligible row: `C05 sdk-libs/client/src/solana_rpc.rs`
- Active reviews: `C05-C20 client prover worker`; `W01-W09 wallet worker`; `C21, C22` deferred until the client retry and error fix commits
...
| ID | Canonical Rust source | TS owner | Status | Verdict | Fix | Gap / fix | Review | Fix commit |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| W01 | `sdk-libs/wallet/src/actions/create_associated_token_account.rs` | `wallet/src/actions.ts` | in_progress | - | none | Claimed by the wallet review worker. | - | - |
