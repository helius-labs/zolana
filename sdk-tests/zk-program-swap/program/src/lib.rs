...
use crate::instructions::{
    process_cancel_ix, process_make_ix, process_take_batch_ix, process_take_ix,
    process_take_verifiable_encryption_ix,
};
...
pub mod tag {
    ...
    pub const TAKE_BATCH: u8 = 6;
    /// Only handled by a `vk-registry` build.
    pub const INIT_VK_REGISTRY: u8 = 7;
}
