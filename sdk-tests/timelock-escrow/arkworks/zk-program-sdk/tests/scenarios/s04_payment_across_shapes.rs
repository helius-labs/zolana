...
impl<const N: usize, const R: usize> zk_program_sdk::circuit::CircuitType
    for circuit::Payment<N, R>
{
}
    ...
    fn instantiate(&self, allocator: &Allocator) -> Result<circuit::Payment<N, R>, RelationError> {
        ...
        Ok(circuit::Payment {
            ...
            public: circuit::PaymentPublicInputs {
                recipients: self.public.recipients.instantiate(allocator)?,
            },
        })
    }
}
...
mod circuit {
    ...
    pub struct Payment<const N: usize, const R: usize> {
        pub private: PaymentPrivateInputs<N, R>,
        pub public: PaymentPublicInputs<R>,
    }
    ...
    impl<const R: usize> PublicInputs for PaymentPublicInputs<R> {
        fn hash(&self, transaction_hash: &CircuitVar) -> Result<CircuitVar, RelationError> {
            ...
            inputs.push(transaction_hash.clone());
            poseidon(&inputs)
        }
    }
}
