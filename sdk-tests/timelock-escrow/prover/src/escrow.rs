use crate::{
    ...
    zk_program::TransactionProofInputs,
    CircuitId, EscrowTermsProofInput, ProofInputUtxo, TimelockProof, PROVER,
};
...
mod tests {
    ...
    fn proof_input_keys_match_circuit_fields() {
        ...
        .into();
        expected.extend(utxo_proof_input_keys("Source"));
