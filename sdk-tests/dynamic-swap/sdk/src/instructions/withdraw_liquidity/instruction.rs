...
impl WithdrawLiquidity {
    pub fn instruction(self) -> Result<Instruction> {
        ...
        // output tree, SPP, System Program, input tree, one nullifier PDA per
        // input, the pool authority owner-signer, then the SplWithdrawal
        // settlement group. The builder marks owner signers
