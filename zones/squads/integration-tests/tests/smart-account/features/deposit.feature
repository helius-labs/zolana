Feature: Squads smart-account deposits move real funds through SPP
  ...
  Scenario: deposit SOL through the zone
    ...
    And the backend auditor decrypts alice's SOL balance as 1000000 lamports
  ...
  Scenario: deposit SPL through the zone
    ...
    And the backend auditor decrypts bob's SPL balance as 500 tokens
