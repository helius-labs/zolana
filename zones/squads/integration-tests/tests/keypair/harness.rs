...
use zolana_squads_client::{
    authorization::InsecurePermissiveRead, RequestCreateViewingKeyAccountRequest,
    RequestCreateViewingKeyAccountResponse, SquadsBackend,
};
...
pub struct SquadsKeypairHarness {
...
impl std::fmt::Debug for SquadsKeypairHarness {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str("SquadsKeypairHarness")
    }
}
