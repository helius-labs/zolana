...
pub const STATE_TREE_DEFAULT_NUM_ITERS: usize = STATE_BLOOM_FILTER_NUM_HASHES as usize;
...
pub const STATE_TREE_DEFAULT_RH: usize = (DEFAULT_BATCH_SIZE / DEFAULT_ZKP_BATCH_SIZE * 2) as usize;
pub const STATE_TREE_DEFAULT_BLOOM: usize = (STATE_BLOOM_FILTER_CAPACITY / 8) as usize;
pub const STATE_TREE_DEFAULT_ZKP: usize = (DEFAULT_BATCH_SIZE / DEFAULT_ZKP_BATCH_SIZE) as usize;
pub const STATE_TREE_DEFAULT_QBATCH: usize = DEFAULT_BATCH_SIZE as usize;
