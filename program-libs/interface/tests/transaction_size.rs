...
fn v1_fit(
    ...
    let mut metas = vec![
        ...
        AccountMeta::new(Address::new_unique(), false),
        AccountMeta::new_readonly(Address::from(SHIELDED_POOL_PROGRAM_ID), false),
        AccountMeta::new_readonly(Address::default(), false),
    ];
    for _ in 0..n_in + extra_accounts {
        metas.push(AccountMeta::new(Address::new_unique(), false));
    }
...
fn merge_v1_fit(
    ...
    let instruction = if ring {
        MergeRing {
            ...
            ring_program_id: Address::new_unique(),
            payer,
            data: data.clone(),
    ...
    for _ in 0..extra_accounts {
        instruction
            .accounts
            .push(AccountMeta::new(Address::new_unique(), false));
    }
    instruction
        .data
