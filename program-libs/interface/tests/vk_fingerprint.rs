...
//! (`prover/server/scripts/keys.py`); a regeneration rewrites
...
fn verifying_key_fingerprint_is_pinned() {
    let keys: [(&str, &Groth16Verifyingkey); 41] = vks![
        merge_8_1,
        merge_36_1,
        merge_ring_8_1,
        merge_ring_36_1,
    ...
    assert_eq!(
        fingerprint, "0023d54bb2eb246007ba4f63cec2e4597acf13a9d131ca193b737d23258038f8",
