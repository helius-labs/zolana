...
fn verifying_key_fingerprint_is_pinned() {
    let keys: [(&str, &Groth16Verifyingkey); 45] = vks![
        merge_8_1,
        merge_36_1,
        merge_receipt_8_1,
        merge_receipt_36_1,
        merge_ring_8_1,
        merge_ring_36_1,
        nullifier_receipt_8_0,
        nullifier_receipt_512_0,
    ...
    assert_eq!(
        fingerprint, "0010189e30a035ddb13d03771b5faa5a661218f4bfcd266971ac768cd678dbf3",
