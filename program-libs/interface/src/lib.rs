...
/// Largest output count among the supported transact circuits.
pub const MAX_TRANSACT_OUTPUTS: usize = shape::max_outputs(&shape::SPP_SUPPORTED_SHAPES);

/// Largest input count among the supported transact circuits.
