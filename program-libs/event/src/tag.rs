...
// Administration, gated by the authorities named in `protocol_config`.
...
pub const SET_TREE_FEES: u8 = 4;
pub const CLAIM_TREE_LAMPORTS: u8 = 5;
pub const CREATE_ASSET_COUNTER: u8 = 6;
pub const CREATE_SPL_INTERFACE: u8 = 7;
pub const CREATE_RING_CONFIG: u8 = 8;
pub const UPDATE_RING_CONFIG: u8 = 9;
...
pub const SET_RING_ACTIVATION: u8 = 11;

// Forester maintenance, gated by `protocol_config.forester_authority`.
pub const BATCH_UPDATE_NULLIFIER_TREE: u8 = 12;
pub const CLOSE_NULLIFIER_PDAS: u8 = 13;
...
pub const DEPOSIT: u8 = 15;
pub const TRANSACT: u8 = 16;
pub const MERGE_TRANSACT: u8 = 17;

// Policy-ring instructions.
pub const RING_DEPOSIT: u8 = 18;
pub const RING_TRANSACT: u8 = 19;
