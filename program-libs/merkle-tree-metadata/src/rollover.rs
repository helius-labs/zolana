...
impl borsh::BorshSerialize for RolloverMetadata {
    fn serialize<W: borsh::io::Write>(&self, writer: &mut W) -> borsh::io::Result<()> {
        borsh::BorshSerialize::serialize(&self.index, writer)?;
        borsh::BorshSerialize::serialize(&self.rollover_fee, writer)?;
        borsh::BorshSerialize::serialize(&self.rollover_threshold, writer)?;
        borsh::BorshSerialize::serialize(&self.network_fee, writer)?;
        borsh::BorshSerialize::serialize(&self.rolledover_slot, writer)?;
        borsh::BorshSerialize::serialize(&self.close_threshold, writer)?;
        borsh::BorshSerialize::serialize(&self.additional_bytes, writer)
    }
}

impl borsh::BorshDeserialize for RolloverMetadata {
    fn deserialize_reader<R: borsh::io::Read>(reader: &mut R) -> borsh::io::Result<Self> {
        Ok(Self {
            index: borsh::BorshDeserialize::deserialize_reader(reader)?,
            rollover_fee: borsh::BorshDeserialize::deserialize_reader(reader)?,
            rollover_threshold: borsh::BorshDeserialize::deserialize_reader(reader)?,
            network_fee: borsh::BorshDeserialize::deserialize_reader(reader)?,
            rolledover_slot: borsh::BorshDeserialize::deserialize_reader(reader)?,
            close_threshold: borsh::BorshDeserialize::deserialize_reader(reader)?,
            additional_bytes: borsh::BorshDeserialize::deserialize_reader(reader)?,
        })
    }
}
