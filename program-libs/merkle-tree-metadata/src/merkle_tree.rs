...
impl anchor_lang::IdlBuild for MerkleTreeMetadata {}

impl borsh::BorshSerialize for MerkleTreeMetadata {
    fn serialize<W: borsh::io::Write>(&self, writer: &mut W) -> borsh::io::Result<()> {
        ...
        crate::serialize_address(&self.associated_queue, writer)?;
        crate::serialize_address(&self.next_merkle_tree, writer)
    }
}

impl borsh::BorshDeserialize for MerkleTreeMetadata {
    fn deserialize_reader<R: borsh::io::Read>(reader: &mut R) -> borsh::io::Result<Self> {
        Ok(Self {
            ...
            associated_queue: crate::deserialize_address(reader)?,
            next_merkle_tree: crate::deserialize_address(reader)?,
        })
    }
}
