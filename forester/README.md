...
| `FORESTER_E2E_ITERATIONS` | Number of transaction iterations to submit (default: `100`) |
| `FORESTER_E2E_EXPECTED_MIN_PROCESSED_ITEMS` | Minimum processed items required before assertions (default: submitted iterations; root `justfile` exports `100`) |
| `FORESTER_E2E_TIMEOUT_SECONDS` | Work-report wait timeout (default: `300` in direct cargo runs; root `justfile` exports `900`) |
| `FORESTER_E2E_SLOT_WARP_STEP` | Local validator slot warp increment (default: `50`) |
| `FORESTER_E2E_SLOT_WARP_INTERVAL_MS` | Delay between local slot warps (default: `2000`) |
