...
1. `program-tests/shielded-pool/invariants/zone-config.md` -> `program-tests/shielded-pool/invariants/ring-config.md`
1. `program-tests/shielded-pool/tests/zone_config/contract.rs` -> `program-tests/shielded-pool/tests/ring_config/contract.rs`
1. `program-tests/shielded-pool/tests/zone_config/update_owner.rs` -> `program-tests/shielded-pool/tests/ring_config/update_owner.rs`
...
1. `program-tests/test-utils/src/zone/mod.rs` -> `program-tests/test-utils/src/ring/mod.rs`
1. `program-tests/test-utils/src/zone/merge_zone.rs` -> `program-tests/test-utils/src/ring/merge_ring.rs`
1. `program-tests/test-utils/src/zone/zone_authority_transact.rs` -> `program-tests/test-utils/src/ring/ring_authority_transact.rs`
1. `program-tests/test-utils/src/zone/zone_config.rs` -> `program-tests/test-utils/src/ring/ring_config.rs`
1. `program-tests/test-utils/src/zone/zone_deposit.rs` -> `program-tests/test-utils/src/ring/ring_deposit.rs`
1. `program-tests/test-utils/src/zone/zone_transact.rs` -> `program-tests/test-utils/src/ring/ring_transact.rs`
...
1. `program-tests/zone-test-program/tests/p256_zone_lifecycle.rs` -> `program-tests/ring-test-program/tests/p256_ring_lifecycle.rs`
1. `program-tests/zone-test-program/tests/proof_cu.rs` -> `program-tests/ring-test-program/tests/proof_cu.rs`
1. `program-tests/zone-test-program/tests/zone_lifecycle.rs` -> `program-tests/ring-test-program/tests/ring_lifecycle.rs`
