...
use crate::{
    actor::Actor,
    localnet::{restart_localnet, send_transaction, DEFAULT_INDEXER_URL, DEFAULT_RPC_URL, ZERO},
...
impl ZoneHarness {
    pub(crate) fn new() -> Result<Self> {
        ...
        let prover = std::thread::spawn(zolana_test_utils::prover::spawn_workspace_prover);
        restart_localnet();
