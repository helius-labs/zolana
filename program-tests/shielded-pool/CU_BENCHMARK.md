...
| `create_nullifier_markers`    |      8,643 |      8,643 |
| `apply_output_tree`           |     28,010 |     28,010 |
| `verify_groth16`              |     93,351 |     93,351 |
| `fund_nullifier_markers`      |         49 |         49 |
| `process_instruction`         |         31 |         31 |
...
| `create_nullifier_markers`    |     12,622 |     12,622 |
| `apply_output_tree`           |     28,053 |     28,053 |
| `verify_groth16`              |     93,351 |     93,351 |
| `fund_nullifier_markers`      |         89 |         89 |
| `process_instruction`         |         31 |         31 |
...
| `create_nullifier_markers`    |     16,601 |     16,601 |
| `apply_output_tree`           |     28,964 |     28,964 |
| `verify_groth16`              |     93,351 |     93,351 |
| `fund_nullifier_markers`      |        129 |        129 |
| `process_instruction`         |         31 |         31 |
...
| `create_nullifier_markers`    |     20,580 |     20,580 |
| `apply_output_tree`           |     28,964 |     28,964 |
| `verify_groth16`              |     93,351 |     93,351 |
| `fund_nullifier_markers`      |        169 |        169 |
| `process_instruction`         |         31 |         31 |
...
| `create_nullifier_markers`    |     24,559 |     24,559 |
| `apply_output_tree`           |     28,964 |     28,964 |
| `verify_groth16`              |     93,351 |     93,351 |
| `fund_nullifier_markers`      |        209 |        209 |
| `process_instruction`         |         31 |         31 |
...
| `fill_owner_signer_hashes`    |        114 |        114 |
| `apply_input_tree`            |      2,721 |      2,721 |
| `create_nullifier_markers`    |      8,122 |      8,122 |
| `apply_output_tree`           |     28,964 |     28,964 |
| `verify_groth16`              |     93,351 |     93,351 |
