...
pub use transact_core::{
    ...
    prove_and_verify_transfer, prove_and_verify_transfer_vk, public_input_hash, resolve_outputs,
    set_output_owner_tags, sol_public_slots, spl_public_slots, start_prover,
