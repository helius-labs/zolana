...
- [x] **INV-DEPOSIT-03: SOL rail pins the funder to the depositor**
  ...
  - Location: `programs/shielded-pool/src/instructions/deposit/account.rs` (`SettlementAccountsSol { recipient_account: depositor }` in `fn validate_and_parse`), `settlement/validate.rs` (`fn validate_sol_settlement`)
