...
- [x] **INV-CREATE-PC-01: fee payer must sign**
  ...
  - Location: `programs/shielded-pool/src/instructions/protocol_config/create.rs:16` (`fn process_create_protocol_config`)
...
- [x] **INV-CREATE-PC-06: every config field is initialized from instruction data**
  ...
  - Location: `programs/shielded-pool/src/instructions/protocol_config/create.rs:66-83` (`fn ProtocolConfigInitParams::init`)
  - Severity: High
...
- [x] **INV-CREATE-PC-08: re-initialization is impossible**
  ...
  - Kind: precondition
  - Statement: `create_protocol_config` on an account whose first byte is not 0 (already stamped) returns Err and leaves the stored authorities unchanged; creation of an account that already exists with data fails in the system-program CPI.
  - Location: `programs/shielded-pool/src/instructions/protocol_config/create.rs:69-70` (`check_data_is_zeroed`), `create.rs:33-42`
  - Error: account-checks error / `ShieldedPoolError::InvalidProtocolConfig = 7012`
...
- [x] **INV-UPDATE-PC-01: only the current protocol authority may update**
  ...
  - Location: `programs/shielded-pool/src/instructions/protocol_config/update.rs:22` (`fn process_update_protocol_config`), `loader.rs:72-84` (`fn load_and_validate_protocol_authority_mut`)
  - Error: `ShieldedPoolError::UnauthorizedCaller = 7003`
...
- [x] **INV-UPDATE-PC-03: config account must be writable, program-owned, sized, and stamped**
  ...
  - Location: `programs/shielded-pool/src/instructions/protocol_config/loader.rs:34-51` (`fn load_protocol_config_mut`)
