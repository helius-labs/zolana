...
- [x] **INV-EMIT-EVENT-04: state-changing instructions can always record their event**
  ...
  - Location: `programs/shielded-pool/src/instructions/event.rs:12-46` (`fn emit_encoded_event`, `fn emit_deposit_event`, `fn emit_transact_event`, `fn emit_merge_event`, `fn emit_nullifier_tree_update_event`)
