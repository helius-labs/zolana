...
impl TransferInputsJson {
    pub fn from_inputs(inputs: &TransferInputs) -> Self {
        Self {
            circuit_type: CircuitType::Transfer.to_string(),
...
pub fn to_json(inputs: &TransferInputs) -> String {
    TransferInputsJson::from_inputs(inputs).to_string()
}
