...
func (w *BaseQueueWorker) generateProof(job *ProofJob) (*common.Proof, error) {
	...
	case common.InputCertificateCircuitType, common.NullifierFreshnessCircuitType, common.NullifierFreshnessGKRCircuitType, common.SpendBalanceCircuitType, common.DirectPaymentCircuitType, common.DirectPaymentGKRCircuitType, common.DirectPaymentAdmittedCircuitType, common.DirectPaymentAdmittedDAG10CircuitType:
