...
var expectedFingerprints = map[string]fingerprint{
	...
	"custom_ring_policy":            {constraints: 576526, public: 2},
	"custom_ring_compressed_policy": {constraints: 1906108, public: 2},
	"custom_ring_register_key":      {constraints: 240449, public: 2},
	"custom_ring_deposit":           {constraints: 980546, public: 2},
	"custom_ring_delegate_policy":   {constraints: 564190, public: 2},
