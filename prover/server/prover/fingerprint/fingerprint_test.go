...
var expectedFingerprints = map[string]fingerprint{
	"transfer_confidential_2_3":   {constraints: 50484, public: 2},
	"transfer_ring_2_3":           {constraints: 50589, public: 2},
	"transfer_ring_authority_2_2": {constraints: 47608, public: 2},
	"transfer_p256_ring_2_3":      {constraints: 195545, public: 2},
	"custom_ring_policy":          {constraints: 461814, public: 2},
	"custom_ring_base":            {constraints: 213042, public: 2},
	"merge_8_1":                   {constraints: 160027, public: 2},
	"merge_ring_8_1":              {constraints: 160060, public: 2},
	"batch_address-append_40_10":  {constraints: 333971, public: 2},
}
