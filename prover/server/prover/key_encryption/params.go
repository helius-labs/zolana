...
// RecipientKeyParams is one recovery or auditor recipient. Pubkey is the
// 65-byte uncompressed P-256 point (0x04 || x || y) the shared secret is
// encrypted to.
...
// encryption circuit. The prover does no hashing or encryption. The client
// computes the public-input hash, ciphertexts, and commitments and sends the
// secrets and keys here. NumKeys is the recovery + auditor recipient count.
