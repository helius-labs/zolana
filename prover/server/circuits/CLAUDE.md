...
2. this package must not depend on other packages in rings/prover/server other packages may depend on it
3. every circuit should have its own directory, or file if the directory would only contain one file
4. rings/prover/server/prover defines marshall and proving system glue code
